...
if __name__ == "__main__":
    ...
    # WHACKD_ADDRESS = "0xcf8335727b776d190f9d15a54e6b9b9348439eee"
    WHACKD_ADDRESS = Web3.toChecksumAddress('0xcf8335727b776d190f9d15a54e6b9b9348439eee')
    ...
    def run():
        ...
        scanner = EventScanner(
            ...
            filters={ "address": WHACKD_ADDRESS },
        ...
        whackd_genesis_block = 8943162
        if state.get_last_scanned_block():
            start_block = max(state.get_last_scanned_block() - chain_reorg_safety_blocks, 0)
        else:
            start_block = whackd_genesis_block
